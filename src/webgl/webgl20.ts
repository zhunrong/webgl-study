...
let xAxisRadian = 0
let yAxisRadian = 0
const scaling1 = new Vector3(0.1, 1, 0.1)
const scaling2 = new Vector3(10, 0.1, 10)
const translation1 = new Vector3(0, 100, 0)
const translation2 = new Vector3(0, -55, 0)

function render() {
  gl.clear(gl.COLOR_BUFFER_BIT)
  gl.clear(gl.DEPTH_BUFFER_BIT)

  xAxisRadian += Math.PI / 180
  globalModelMatrix.setTranslation(translation1)
  globalModelMatrix.rotate(xAxisRadian, Vector3.xAxis)
  globalModelMatrix.scale(scaling1)
  drawCube(globalModelMatrix)
  globalModelMatrix.translate(translation2)
  yAxisRadian += Math.PI / 45
  globalModelMatrix.rotate(yAxisRadian, Vector3.yAxis)
  globalModelMatrix.scale(scaling2)
  drawCube(globalModelMatrix)
